...
let addSingleTypes = () => {
    goodsSingleTypes.goodsId = defineSignIds.getGoodsId;
    axiosInstance.post('/goodsSingleTypes/addSingleTypes',goodsSingleTypes)
    .then((response) => {
...
<template>
    <div class="add-single-type-area">
        <div class="page-top">
            <p class="page-top-content">新增商品种类信息</p>
        ...
        <div class="add-same">
            <button class="button" @click="addSingleTypes()">提交</button>
        </div>
    </div>
</template>
