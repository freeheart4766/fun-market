...
//提交修改密码的请求
let changePassword = () => {
    axiosInstance.put('/customer/changePassword',resetPassword)
    .then((response) => {
    ...
    <div class="reset-password-area">
        ...
        <div class="line-single">
            <el-tooltip class="input-tooltip" effect="dark" content="7-16个字符, 可由字母和数字组成" placement="right" trigger="click">
                <el-input class="password-input" v-model="resetPassword.passwordNew" type="password" placeholder="请输入新密码" show-password size="large" @blur="checkPassword()" />
            </el-tooltip>
        </div>
        <div class="line-single">
        ...
        <div class="line-single">
            <button class="submit" @click="changePassword()">提交</button>
        </div>
    </div>
</template>
