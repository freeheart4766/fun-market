...
let register = () => {
    ...
    if(checkUsernameAndPassword && password2 != null && loginAndRegister.verifyCode != null){
        axios.post(`${unificationURL}/admin/register`,
                    loginAndRegister,
    ...
    <div>
        ...
        <div id="main">
            <div id="register-area">
                ...
                <button id="register-button" @click="register()">管理员注册</button>
            </div> 
        </div>
    </div>
</template>
...
#main {
    width: 100%;
    height: 420px;
    background-image: url(../assets/admin-register-background.png);
