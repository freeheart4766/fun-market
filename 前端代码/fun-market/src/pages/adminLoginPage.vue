...
let login = () => {
    ...
    if(checkUsernameAndPassword && loginAndRegister.verifyCode != null){
        axios.post(`${unificationURL}/admin/login`,
                    loginAndRegister,
    ...
    <div>
        ...
        <div id="main">
            <div id="login-area">
                ...
                <button id="login-button" @click="login()">管理员登录</button>
                <div id="router-area">
                    <router-link class="router-to" to="/adminRegister">立即注册</router-link>
                </div>
            </div> 
        </div>
    </div>
